            ...
            <div key={product.id} className={`bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow ${selected ? "ring-2 ring-blue-500" : ""}`}>
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 pt-2">
                  ...
                  {/* Not gated on isSupplierProduct — Master Plan §9/§10's
                      linking (confirmLink) can attach a supplier option to
                      an INTERNAL product too, not just supplier-sourced
                      ones. Every product can have supplier links. */}
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {/* Manage supplier links — NOT gated on isSupplierProduct.
                          ...
                          supplier option to an INTERNAL product too, not
                          just supplier-sourced ones — every product can
                          have supplier links. */}
                      <button onClick={() => onManageSuppliers(product)}
